  ...
  return (
    <div id="places-to-visit">
      ...
      >
        ...
        >
          <CardMedia component="img" height="300px" image={gearsPic} alt="Pic of gears" />
          <CardContent sx={{ height: '75px' }}>
            <Typography
              gutterBottom={true}
              variant="h5"
              component="div"
              sx={{ fontSize: '35px', fontFamily: 'Nunito' }}
            >
              Admin Page
            </Typography>
            <Typography
              variant="body3"
              color="white"
              sx={{ fontSize: '20px', fontFamily: 'Nunito' }}
            >
          ...
          <CardActions sx={{ justifyContent: 'center' }}>
            <Link to="admin" style={{ textDecoration: 'none' }}>
              <Button
                ...
                color="success"
              >
                <Typography sx={{ fontSize: '32px', fontFamily: 'Nunito' }}>ADMIN</Typography>
              </Button>
            </Link>
          </CardActions>
        </Card>
        ...
        >
          <CardMedia component="img" height="300px" image={shoppingPic} alt="Shopping cart" />
          <CardContent sx={{ height: '75px' }}>
            <Typography
              gutterBottom={true}
              variant="h5"
