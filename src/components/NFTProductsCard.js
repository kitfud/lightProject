              ...
              InputProps={{
                ...
                endAdornment: (
                  <InputAdornment position="end">
                    {prodCurrentPrice
                      ? `(ETH ${(prodCurrentPrice / ETHUSDConversionRate).toFixed(6)})`
                      : `(ETH ${(0).toFixed(6)})`}
                  </InputAdornment>
                ),
              }}
            ...
            <TextField
              ...
              InputProps={{
                ...
                endAdornment: (
                  <InputAdornment position="end">
                    {productNewPrice
                      ? `(ETH ${(productNewPrice / ETHUSDConversionRate).toFixed(6)})`
                      : `(ETH ${(0).toFixed(6)})`}
                  </InputAdornment>
                ),
              }}
              ...
              sx={{ maxWidth: 300 }}
            />
            <Button onClick={setNewProductPrice} variant="contained" color="secondary">
              {loading ? <CircularProgress color="inherit" /> : 'Change price'}
            </Button>
          </FormControl>
          <FormControl sx={{ padding: 1 }}>
            <TextField
            ...
            <TextField
              ...
              InputProps={{
                ...
                endAdornment: (
                  <InputAdornment position="end">
                    {newProductPrice
                      ? `(ETH ${(newProductPrice / ETHUSDConversionRate).toFixed(6)})`
                      : `(ETH ${(0).toFixed(6)})`}
                  </InputAdornment>
                ),
              }}
              sx={{ maxWidth: 300 }}
            />
            <Button variant="contained" color="secondary" onClick={addNewProduct}>
